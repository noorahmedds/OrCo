...
class SupConLoss(nn.Module):
    ...
    def forward(self, features, labels=None, queue_labels=None, mask=None, margin = 0, hemisphere = False, pert_count = None):
        ...
        # Here we can incorporate the queue from our key momentum encoder
        # But before that we would need to 

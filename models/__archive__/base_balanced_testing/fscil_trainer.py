        ...
        for session in range(args.start_session, args.sessions):
            ...
            if session == 0:  # load base class train img label
                ...
                if not args.not_data_init:
                    ...
                    # TODO: replace base_fc with using balanced testing scheme from ALICE
                    ...
                    # TODO: Using this testloader also run a temperature scaling optimisation
                ...
                if session == 1 and args.t_scaling:
                    # Before starting the incremental sessions once set the temperature for the base classes
                    _, _, basetestloader = self.get_dataloader(0)
                    tsl, tsa = (test(self.model, basetestloader, 0, args, session = 0, base_sess = True, t_scaling = True))[:2]
                ...
                # if args.t_scaling:
                #     # Apply t scaling for this session after both sessions
                #     self.model.module.test_fc(self.model.module.fc.weight, testloader, 0, session, t_scaling=True)

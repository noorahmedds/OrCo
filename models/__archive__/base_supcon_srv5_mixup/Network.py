            ...
            for epoch in tqdm_gen:
                ...
                for idx, batch in enumerate(baseloader):
                    ...
                    if self.args.class_aug_base:
                        images, label = mixup_pairs(images, label, curr_mix_pair, self.args.base_class, alpha=self.args.mixup_alpha)
            ...
            for epoch in tqdm_gen:
                ...
                for batch in jointloader:
                    ...
                    if self.args.class_aug_inc:
                        images, label = mixup_pairs(images, label, curr_mix_pair, self.args.base_class+(self.args.way*session), alpha=self.args.mixup_alpha)

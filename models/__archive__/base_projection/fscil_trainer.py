        ...
        for session in range(args.start_session, args.sessions):
            ...
            if session == 0:  # load base class train img label
                ...
                if not args.not_data_init:
                    ...
                    # Remove the projection layer here. So that the replacing base fc function is not meddled with.
                    self.model.module.apply_projection = False
                ...
                # Override projection application
                self.model.module.apply_projection = False  # In the case of training continuation

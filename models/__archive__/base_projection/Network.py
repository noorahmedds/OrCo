...
class MYNET(nn.Module):
    ...
    def __init__(self, args, mode=None):
        ...
        # TODO: Add a projection layer before the fc layer. and remove it right after the base training has finished
        # Two layer mlp with a hidden feature size of 2048 and relu as the activation

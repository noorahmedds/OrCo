...
class MYNET(nn.Module):
    ...
    def update_fc_ft_joint(self, jointloader, testloader, class_list, session):
        ...
        self.fc.weight.data[self.args.base_class:self.args.base_class + (self.args.way * (session-1)), :].copy_(best_fc.data[self.args.base_class:self.args.base_class + (self.args.way * (session-1)), :])

    ...
    def train(self):
        ...
        for session in range(args.start_session, args.sessions):
            ...
            if session == 0:  # load base class train img label
                self.model.module.mode = 'ft_multi'      # Mode for testing if the base fc is replaced by the average feature vector
                ...
                print(f"\n\n===== hm after Novel Session {tsHm}, novel = {tsaNovel}, base = {tsaBase}")

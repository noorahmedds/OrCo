...
class MYNET(nn.Module):
    ...
    def update_fc_joint(self,jointloader, testloader, class_list, session, generated = None):
            ...
            for epoch in tqdm_gen:
                ...
                if self.args.validation_metric == "hm":
                    ...
                    if best_hm is None or vhm > best_hm:
                        ...
                        hm_patience_count += 1
                    out_string = '(Joint) Sess: {}, loss {:.3f}, trainAcc {:.3f}, testAcc {:.3f}, bestHM {:.3f}, b/n={:.3f}/{:.3f}, ALG {:.3f}, ALGb/n {:.3f}/{:.3f}'\
                        .format(
                            session, 
                            total_loss,
                            float('%.3f' % (ta.item() * 100.0)),

...
class MYNET(nn.Module):
    ...
    def __init__(self, args, mode=None):
        ...
        if self.args.dataset in ['mini_imagenet']:
            ...
            # Total trainable parameters: 12462720 (1.255.488 more than resnet18)
    ...
    def freeze_session_fc_lt(self, session = 0):
        ...
        # Freeze the previous layers. We do not need updates to the base 
        # Do we need to freeze them per say?
        # Would this reduce their performance?
        # If i don't freeze the weights there contributing weights would be effected
        pass
    ...
    def update_fc_ft_novel(self, new_fc, trainloader, testloader, session):
        ...
        if not self.args.freeze_backbone:
            optimized_parameters.append({"params": self.encoder.parameters()})
            self.theta1 = deepcopy(self.encoder.state_dict())
        ...
        with torch.enable_grad():
            ...
            for epoch in tqdm_gen:
                ...
                for data, label in trainloader:
                    ...
                    if not self.args.freeze_backbone:
                        loss += KP_loss(self.theta1, self.encoder.state_dict())

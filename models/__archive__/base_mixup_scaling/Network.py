...
class MYNET(nn.Module):
    ...
    def update_fc_ft_novel(self, new_fc, trainloader, testloader, session):
        ...
        base_temp = self.args.base_class / (self.args.way * session)
        ...
        with torch.enable_grad():
            ...
            for epoch in tqdm_gen:
                ...
                for data, label in trainloader:
                    ...
                    logits[:, :self.args.base_class] = logits[:, :self.args.base_class] / 0.1
                    logits[:, self.args.base_class:] = logits[:, self.args.base_class:] / 0.04

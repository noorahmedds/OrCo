        ...
        with torch.enable_grad():
            ...
            for epoch in tqdm_gen:
                ...
                for data, label in trainloader:
                    ...
                    # TODO: Apply margin. I.e. subtract from the logits 0.4 for the current target
                    # logits[label] -= 0.4, this should subtract 0.4 from the logits output which corresponds to the current output

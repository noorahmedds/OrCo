...
def parse_cfg(cfg: omegaconf.DictConfig):
    ...
    for pipeline in cfg.augmentations:
        ...
        # Asserting auto augment as false if it doesnt exist
        pipeline.auto_augment = omegaconf_select(pipeline, "auto_augment", False)
        pipeline.aa_string = omegaconf_select(cfg, "data.aa_string", "rand-m9-mstd0.5-inc1")
